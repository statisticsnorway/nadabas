...
Dim savetimestampfield As String
    ...
    For i = scanres.RowIDFields.count + 1 To scanres.orgDataRange.Columns.count
        ...
        SetColAndRowIDRange scanres
          ...
          For Each rci In scanres.ColIdFields
               rci.RowColValue = Trim(scanres.orgColIdRange.Cells(rci.RowColNumber, i - scanres.RowIDFields.count).value)
          ...
          If Not DropYear Then
             ...
             savetimestampfield = scanres.TimeStampField
             DoGetDataToDataRange awb, scanres
             scanres.ValuesField = savevaluesfield
             scanres.TimeStampField = savetimestampfield
          End If
      Next i
